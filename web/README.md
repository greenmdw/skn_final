...
기본(백엔드 연결) 모드에서 추천 구성·가격·추천 이유·리뷰 건수는 서버 응답입니다. 아직 샘플인 것: 인터뷰 문답(채팅의 목적·성능 질문), 견적 점검 화면(`/check`)의 부품 목록과 추가 질문 대화, 조립 가이드 문장, 약관 본문. 구성이 나온 뒤의 후속 질문과 업그레이드 제안 카드는 서버 응답이다.
